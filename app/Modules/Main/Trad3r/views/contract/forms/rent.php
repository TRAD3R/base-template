                ...
                <div class="configurator-box__body">
                    ...
                    <div class="row mt-80">
                        <div class="w-100 max-w-820">
                            ...
                            <div class="form-group">
                                <p class="headers-h3 c-accent__lighten mt-20">Арендодатель
                                    <?=in_array($type, [Contract::CONTRACT_RENT_MEDICAL_TWO_OWNER, Contract::CONTRACT_RENT_PAHRM_TWO_OWNER]) ? 1 : ''?>
                                </p>
                                <label for="id-date-contract-begin" class="label form-group__label">
                            ...
                            <div class="form-group">
                                ...
                                <?=Html::activeTextInput($model, 'ownerData', [
                                    'class' => 'dr-form-control form-control',
                                    'placeholder' => ' ',
                                    'required' => true,
                                ])?>
                            ...
                            <?php if (in_array($type, [Contract::CONTRACT_RENT_MEDICAL_TWO_OWNER, Contract::CONTRACT_RENT_PAHRM_TWO_OWNER])):?>
                                <div class="form-group">
                                    <p class="headers-h3 c-accent__lighten mt-20">Арендодатель 2</p>
                                    <label for="id-date-contract-begin" class="label form-group__label">
                                        <?=Html::activeLabel($model, 'owner2', ['class' => 'label form-group__label'])?>
                                    </label>
                                    <?=Html::activeTextInput($model, 'owner2', [
                                        'class' => 'dr-form-control form-control',
                                        'placeholder' => ' ',
                                        'required' => true,
                                    ])?>
                                ...
                                <div class="form-group">
                                    <label for="id-date-contract-begin" class="label form-group__label">
                                        <?=Html::activeLabel($model, 'owner2Data', ['class' => 'label form-group__label'])?>
                                    </label>
                                    <?=Html::activeTextInput($model, 'owner2Data', [
                                        'class' => 'dr-form-control form-control',
                                        'placeholder' => ' ',
                                        'required' => true,
                                    ])?>
                            ...
                            <div class="form-group">
                                ...
                                <label for="id-date-contract-begin" class="label form-group__label">
                                    <?=Html::activeLabel($model, 'renterName', ['class' => 'label form-group__label'])?>
                                </label>
                                <?=Html::activeTextInput($model, 'renterName', [
                                    'class' => 'dr-form-control form-control',
                            ...
                            <div class="form-group">
                                ...
                                <?=Html::activeTextInput($model, 'renterPosition', [
                                    'class' => 'dr-form-control form-control',
                            ...
                            <div class="form-group">
                                <label for="id-date-contract-begin" class="label form-group__label">
                                    <?=Html::activeLabel($model, 'renterData', ['class' => 'label form-group__label'])?>
                                </label>
                                <?=Html::activeTextarea($model, 'renterData', [
                                    'class' => 'dr-form-control form-control',
                            ...
                            <div class="form-group">
                                <label for="id-date-contract-begin" class="label form-group__label">
                                    <?=Html::activeLabel($model, 'number', ['class' => 'label form-group__label'])?>
                                </label>
                                <?=Html::activeTextInput($model, 'number', [
                                    'class' => 'dr-form-control form-control',
                                    'placeholder' => 'Выписка из ЕГРН №323434, кад.номер 234234234234. Выдано 20.09.2020',
                                    'required' => true,
                                ])?>
                                <div class="form-group__message error"></div>
                            </div>
                            <div class="form-group">
                                <label for="id-date-contract-begin" class="label form-group__label">
                                    <?=Html::activeLabel($model, 'square', ['class' => 'label form-group__label'])?>
                                </label>
                                <?=Html::activeTextInput($model, 'square', [
                                    'class' => 'dr-form-control form-control',
                                    'placeholder' => ' ',
                                    'required' => true,
                                ])?>
